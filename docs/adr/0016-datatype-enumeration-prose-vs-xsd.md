...
- **Статус:** принято и реализовано (N-59, решение владельца от 2026-08-16, приоритет источников ROADMAP §1.2); срез M1.6-14 верифицирован владельцем — 482/0, `examples/run` exit 0
- **Дата:** 2026-08-16
