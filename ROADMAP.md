...
#### M1.0-5. Замена `ROADMAP.md` и починка ссылок (P3) — закрывает N-42 — `[~]` выполняется в PR-1
...
#### M1.1-1. Исправить развёртку BOM (P0) — закрывает N-01 — `[~]` реализовано (верификация — владелец)
...
#### M1.1-2. Единый предикат конфликта §3.4 и корректный `Patch` (P0) — закрывает N-02, частично N-16 — `[~]` реализовано (верификация — владелец)
...
#### M1.1-3. Исправить `Patch.mergeResourceSets` (P0) — закрывает N-02 — `[~]` реализовано (верификация — владелец)
...
#### M1.1-4. Уточнить `IntegerRange` (P2) — закрывает X-02 — `[~]` реализовано (верификация — владелец)
